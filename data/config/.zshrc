...
export PATH=$PATH:$GOROOT/bin:$GOPATH/bin:$HOME/.npmglobal/bin:/home/abhishek/.local/bin:$HOME/.cargo/bin:/usr/local/go/bin:$HOME/Utils/flutter/bin:$HOME/Utils/android-studio/bin